        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    iduserdir = table.Column<int>(type: "int", nullable: false),
                    IDOrder = table.Column<int>(type: "int", nullable: false),
                    idProductInter = table.Column<int>(type: "int", nullable: false),
                    idUser = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cart_InterProd_idProductInter",
                        column: x => x.idProductInter,
                        principalTable: "InterProd",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cart_idProductInter",
                table: "Cart",
                column: "idProductInter");
